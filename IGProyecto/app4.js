...
db.collection("asociados").onSnapshot((querySnapshot) => {
...
function eliminar(id){
    ...
    db.collection("asociados").doc(id).delete().then(function() {
...
var washingtonRef = db.collection("asociados").doc(id);
