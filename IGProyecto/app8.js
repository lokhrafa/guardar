...
function guardar(){
    ...
    db.collection("facturadegastos").add({
...
db.collection("facturadegastos").onSnapshot((querySnapshot) => {
    ...
    querySnapshot.forEach((doc) => {
        ...
        <td> <button class="btn btn-warning" onclick="editar('${doc.id}','${doc.data().FacturaID}','${doc.data().ProyectoID}','${doc.data().Numfactura}','${doc.data().Numcorte}','${doc.data().FechaDePago}','${doc.data().Monto}', '${doc.data().Moneda}','${doc.data().Tasa}','${doc.data().Observaciones}', '${doc.data().TerceroID}')">Editar</button></td>
      </tr>`
...
function eliminar(id){
    ...
    db.collection("facturadegastos").doc(id).delete().then(function() {
...
function editar(id,nombre,apellido,fecha,productoid,asociadoid,fechainicio,fechafinal,moneda,tasa,observaciones,terceros){
...
document.getElementById('terceros').value = terceros;
...
var washingtonRef = db.collection("facturadegastos").doc(id);
