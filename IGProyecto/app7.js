...
function guardar(){
    ...
    db.collection("pagodefacturasdeventas").add({
...
db.collection("pagodefacturasdeventas").onSnapshot((querySnapshot) => {
    ...
    querySnapshot.forEach((doc) => {
        ...
        <td> <button class="btn btn-warning" onclick="editar('${doc.id}','${doc.data().FacturaID}','${doc.data().ProyectoID}','${doc.data().Numfactura}','${doc.data().Numcorte}','${doc.data().FechaDePago}','${doc.data().Monto}', '${doc.data().Moneda}','${doc.data().Tasa}','${doc.data().Observaciones}')">Editar</button></td>
      </tr>`
...
function eliminar(id){
    ...
    db.collection("pagodefacturasdeventas").doc(id).delete().then(function() {
...
var washingtonRef = db.collection("pagodefacturasdeventas").doc(id);
